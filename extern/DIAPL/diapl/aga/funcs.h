...
extern void make_vectors(double *, double **, double **, double **, PARAMS);
extern void make_domains(double *, unsigned short *, double **, DOM_TABS *, PARAMS);
extern void clone_domains(DOM_TABS *, int, int);
extern void mask_badpix(double *, unsigned short *, unsigned short *, int, PARAMS);
extern int  clean_domains(double *, double *, unsigned short *, unsigned short *,
			  double **, DOM_TABS *, PARAMS);
extern void get_domains(double *, unsigned short *, DOM_TABS *, PARAMS, int *);
extern int  max(int, int, int, double *, int);

/* sigma clipping and local value of fit */

extern void quick_sort(double *, int *, int);
extern  int local_clip(double *, double *, unsigned short *, double **,
		       double **, double *, DOM_TABS *, PARAMS, double *, int *);
extern  int clip_domains(DOM_TABS *, double *, int *, int, double*, PARAMS);
extern void local_solution(int, int, double **, double *, double *, PARAMS);

/* basis function for kernel decomposition */

extern double base_func(double, int, int, double *, double *, int, int);
...
extern void xy_convolve(double *, double *, double *, int, int,
			double *, double *, int);
extern void spatial_convolve(double *, double *, double **, double **,
			     double *, PARAMS);
...
extern void apply_norm(double *, unsigned short *, unsigned short *,
