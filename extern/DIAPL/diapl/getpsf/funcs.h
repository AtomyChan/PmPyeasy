...
extern void init_bkg(IMAGE *, BKG_STRUCT *, double, double);
extern double getbkg(IMAGE *, BKG_STRUCT *, int, int);
extern int is_peak(IMAGE *, int, int, int, double);
...
extern void free_vector(double *, int, int);
...
extern void clip_stars(OBJ_LIST *, double, int *);
