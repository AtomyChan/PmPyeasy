/*========================================================*/
/*                                                        */
/*  centroid.c          version 1.2.3   2005.01.24        */
/*                                                        */
...
/*                                                        */
/* Given im(nx, ny) and pixel (cx, cy) which is           */
/* a local maximum calculates centroid (x, y).            */
/*                                                        */
/*========================================================*/
...
void centroid(double *difim, int nx, int ny,
              int cx, int cy, double *x, double *y)
{
        int   i, j;
...
/* the same in y direction */
  ...
  for (j=-1; j<=1; j++)
  {
    ...
    for (i=-1; i<=1; i++) marg[j+1] += difim[cx+i+nx*(cy+j)];
  }
