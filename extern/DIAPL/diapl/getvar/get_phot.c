/*========================================================*/
/*                                                        */
/*  get_phot.c          version 1.2.3   2005.01.24        */
/*                                                        */
...
void get_phot(double *difim, double *im, double *refim, double x, double y,
              int cx, int cy, double *psfim, STAR *obj, PAR_STRUCT *par)
{
  ...
  {
    obj->p_flux = (double)(p_phot/p_sig2);
    obj->p_err  = (double)(1.0/sqrt(p_sig2*gain));
    obj->chi2_n = (double)((p_sum2 - p_phot*p_phot/p_sig2)*gain/count);
    obj->corr   = (double)(sum_a/sqrt(sum_b*sum_c));

    obj->a_flux = (double)(a_phot);
    obj->a_err  = (double)(sqrt(a_sig2/gain));
    obj->nbad   = nbad;
  }
  else
  {
