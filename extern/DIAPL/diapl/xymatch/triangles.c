...
void triangles(double *x1, double *y1, double *x2, double *y2,
               int nobj1, int nobj2, int *xx, PARAMS par)
{
  ...
  if (!(perim1=(double *)malloc(ntri1*sizeof(double)))) errmess("malloc(perim1)");
  if (!(perim2=(double *)malloc(ntri2*sizeof(double)))) errmess("malloc(perim2)");
  if (!(rat1  =(double *)malloc(ntri1*sizeof(double)))) errmess("malloc(rat1)");
  if (!(rat2  =(double *)malloc(ntri2*sizeof(double)))) errmess("malloc(rat2)");
  if (!(cos1  =(double *)malloc(ntri1*sizeof(double)))) errmess("malloc(cos1)");
  if (!(cos2  =(double *)malloc(ntri2*sizeof(double)))) errmess("malloc(cos2)");
