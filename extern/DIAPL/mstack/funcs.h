...
extern float median(float *, float *, int, float, float, float);
extern void histogram(float *, int, int, float *, int, float, float);
extern void bin(float *, int, float *, int);
extern void get_peak(float *, float *, int, int, float *, float *);
